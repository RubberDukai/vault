...
| 1.10 | Language learning: English + Japanese first, then Spanish, Mandarin, Hindi | **PARTIAL** | 1,952 cards with spaced repetition; written grammar guides for all four; cards spoken aloud with the Say it button (P) or Auto, using the voices installed in Windows — offline, but only for languages whose voice pack is installed (Settings › Time & language › Speech). Still to do: A2, N4, HSK 2 |
...
| 6.4 | Languages | Guides for all four. Spoken audio via the Windows voices (1.10). Japanese covers all of N5, Spanish most of A1; Mandarin is complete to HSK 2; Hindi has the full script and a quarter of A1 — see 9.15 |
