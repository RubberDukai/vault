...
2. **`node tools/make-portable.js <folder> --with-node --with-packs --with-maps`** — builds a copy that runs from a stick with no install.
3. **Installing it on the other devices.**
